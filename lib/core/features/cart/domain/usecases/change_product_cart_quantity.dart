...
@lazySingleton
class ChangeProductCartQuantity implements UseCase<void, ChangeProductCartQuantityParams> {
  final CartRepository repository;

  ChangeProductCartQuantity(this.repository);

  @override
  Future<Either<Failure, void>> call(ChangeProductCartQuantityParams params) async {
