...
@lazySingleton
class GetQuantityCartProducts implements UseCase<String, NoParams> {
  late final CartRepository repository;

  GetQuantityCartProducts(this.repository);

  @override
  Future<Either<Failure, String>> call(NoParams params) async {
    return await repository.getTotalProductsQuantityOnCart();
  }
}
